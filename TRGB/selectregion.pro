...
IF (keyword_set(XRANGEVEC)) THEN BEGIN
    IF (keyword_set(YRANGEVEC)) THEN BEGIN
        plot, xvec, yvec, psym=psymnum, /ynozero, xrange=xrangevec, yrange=yrangevec, $
          /xstyle, /ystyle, /nodata, title = title, xtitle = xtitle, ytitle = ytitle
...
;Make plot of ploygon and print to file
IF (keyword_set(XRANGEVEC)) THEN BEGIN
    IF (keyword_set(YRANGEVEC)) THEN BEGIN
        plot, xvec, yvec, psym=psymnum, /ynozero, xrange=xrangevec, yrange=yrangevec, $
          /xstyle, /ystyle, /nodata, title = tile, xtitle = xtitle, ytitle = ytitle
        oplot, xvec, yvec, color=0, psym=psymnum
    ENDIF ELSE BEGIN
        plot, xvec, yvec, psym=psymnum, /ynozero, xrange=xrangevec, /xstyle, /nodata, $
          title = title, xtitle = xtitle, ytitle = ytitle
        oplot, xvec, yvec, color=0, psym=psymnum
...
oplot, xpoly, ypoly, color=colorval;, psym=psymnum, color=colorval
device,/close
set_plot,'x'
