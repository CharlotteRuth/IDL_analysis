pro find_shocked, phase, haloidoutput, haloid, WMAP1=wmap1
...
for j=0,nsteps-1 do begin
  ...
  tvir[j] = 1.7306277e-07*mvir*mu/(rvir/1000.)
  rvir[j] = rvir0
endfor

;phase = mrdfits('grp1.allgas.entropy.fits',1)
smaccr = mrdfits('grp' + haloid + '.smooth.accr.iord.fits',0)
...
;sshock = alog10((tvir)^1.5/(4.*om_m*wmap3_rho_crit(z)))
 deltas = sshock-ent
