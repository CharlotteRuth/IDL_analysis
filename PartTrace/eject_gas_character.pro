...
;prior to ejection.  It is based on fb_gas_character

;eject_gas_character,'/home/christensen/Storage2/UW/MolecH/Cosmo/h603.cosmo50cmb.3072g/h603.cosmo50cmb.3072g14HBWK'
PRO eject_gas_character,dir,ejecthistory,expellhistory,finalid = finalid,laststep = laststep
...
eject_dstep = eject_dstep - 1 ;The step when the ejected particles were last in the disk

match2,fix(expellz*1000)/1000.0,fix(halodat.z*1000)/1000.0,expell_hstep,temp
expell_hstep= expell_hstep - 1 ;The step when the expelled particles were last in the halo
match,ejectiord,expelliord,eject_expell_ind,temp
match2,ejectz[eject_expell_ind],halodat.z,expell_dstep,temp
expell_dstep = expell_dstep - 1 ;The step when the expelled particles were last in the disk
...
mwrfits,ejecthistory,'grp' + finalid + '.eject_disk.fits',/create
END
