...
pro checkfit_JEM1,broadbandfile,galfit,fov,filter,rad=rad
...
image = mrdfits(broadbandfile,19)  ;14 face on with dust, 19 without dust
gal =image(*,*,band)
...
;set_plot,'ps'
;device,portrait=1,filename='galfit_B_bulgeless_nodust.eps',/color,/encapsulate
