PRO CONTOUR_PLUS_ORIG, x,y,weight = weight,XBINSIZE=xbinsize,YBINSIZE=ybinsize, $
                  ...
                  LENSCALE = LENSCALE,C_COLOR = C_COLOR,_EXTRA=EXTRA, verbose = verbose
...
hist=HIST_2D_weighted(x,y,xbins = xbins, ybins = ybins, weight = weight,bin1=xbinsize,bin2=ybinsize,min1=xmin,min2=ymin,max1=xmax,max2=ymax)
