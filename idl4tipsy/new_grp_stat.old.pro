...
if name eq 'cosmo50' then begin
  boxsize = 36500. 
  munit=1.84793e16
  vunit = 1261.05
endif
if name ne 'cosmo25' and name ne 'cosmo50' then begin
  munit = 3.171d15
  vunit = 691.0
  h0 = 0.7
  boxsize = 20000.
...
readcol, halosfile[0], npart, nvpart, xc, yc, zc, vxc, vyc, vzc, mvir, rvir, vmax, rmax, sigv, spin, format='l,f,f,f,f,f,f,f,f,f,f,f,f,f'
